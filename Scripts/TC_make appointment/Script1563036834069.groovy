...
WebUI.setText(findTestObject('Page_Appointment/input_Visit Date (Required)_visit_date'), '01/08/2019')

WebUI.setText(findTestObject('Page_Appointment/textarea_Comment_comment'), 'test')

WebUI.click(findTestObject('Page_Appointment/button_Book Appointment'))

WebUI.click(findTestObject('Page_Sumamry/a_Go to Homepage'))
